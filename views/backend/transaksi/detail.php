<html>
  ...
  <body>
     ...
     <table>
     	<tr>
     		<td width="650"><h3>Loundry Online</h3></td>
     		<td><h3>Invoice</h3></td>
     	</tr>
     ...
     <table>
     	<tr>
     		...
     		<td width="480"><?= $transaksi['nama_konsumen'];?></td>
     	...
     	<tr>
     		...
     		<td width="480"><?= $transaksi['alamat_konsumen'];?></td>
     	...
     	<tr>
     		...
     		<td width="480"><?= $transaksi['no_telp'];?></td>
     ...
     <table width="720" class="table">
     	...
     	<tr>
     		...
     		<td class="table"><?= $transaksi['berat'];?>Kg</td>
